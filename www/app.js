...
function sample(){
  ...
  return {
    ...
    foodPurchases:[],
    foodConsumptions:[],
    settings:{dark:false,theme:'light',autoSave:true,googleAutoSync:false,currency:'KRW',dateFormat:'YYYY-MM-DD',periodMode:'rolling'}
  };
}
